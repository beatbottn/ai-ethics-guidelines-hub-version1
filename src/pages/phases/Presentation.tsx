    ...
    <div className="min-h-screen bg-background py-spacing-xl px-spacing-lg md:px-spacing-xl" dir="rtl" lang="he">
      <div className="max-w-content-width mx-auto space-y-spacing-xl">
        ...
        <div className="space-y-spacing-md">
          <h1 className="text-h1 font-bold text-foreground">📊 שלב 4: הצגת ממצאים והמלצות</h1>
        ...
        <div className="space-y-spacing-lg">
          <h2 className="text-h2 font-bold text-primary">משימות נפוצות עם AI בשלב ההצגה</h2>
          {tasks.map((task) => (

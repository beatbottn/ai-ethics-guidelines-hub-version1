...
const challenges = [
  {
    ...
    links: [
      { text: "Reuters - Amazon scraps secret AI recruiting tool", url: "https://www.reuters.com/article/us-amazon-com-jobs-automation-insight-idUSKCN1MK08G" },
      { text: "MIT News - Gender and skin-type bias in AI systems", url: "https://news.mit.edu/2018/study-finds-gender-skin-type-bias-artificial-intelligence-systems-0212" },
    ],
    uxContext:
  ...
  },
  {
    ...
    links: [
      { text: "Stanford HAI - AI hallucinations in legal filings", url: "https://hai.stanford.edu/news/hallucinating-law-legal-mistakes-large-language-models-are-pervasive" },
      { text: "Damien Charlotin Database - Tracking AI hallucinations in court", url: "https://www.damiencharlotin.com/genai-in-courts" },
    ],
    uxContext:
  ...
  },
  {
    ...
    titleEn: "Black Box",
    description:
      'חוסר יכולת להבין כיצד ה-AI הגיע למסקנה מסוימת או לזהות דפוס מסוים. במחקר, זה הופך את תהליך הניתוח למשימה שמאד מקשה על ניתוח ״בעין אנושי״ את התובנות האמיתיות החבויות במידע שנאסף, וזה בעיקר עלול להקשות על זיהוי הטיות נסתרות או איתור של תופעות השטחה כמו - Average washing.',
    realWorldExample:
    ...
    links: [
      { text: "ProPublica - Machine Bias in Criminal Sentencing", url: "https://www.propublica.org/article/machine-bias-risk-assessments-in-criminal-sentencing" },
    ],
    uxContext:
  ...
  },
  {
    ...
    description:
      'מערכות ה-AI לעיתים נכשלות בהגנה על הנתונים או על פרטיות המשתמשים. אחד הסיכונים הוא AI Shadowing - מונח המתאר עובדות.ים המשתמשות.ים בכלי AI לא מאושרים בעבודה (כמו גרסאות חינמיות של LLMs) או ללא פיקוח ובקרה על עבודתם עם AI, מה שמעלה את סיכון דליפת המידע הרגיש.',
    realWorldExample:
    ...
    links: [
      { text: "Incident Database AI - Samsung case", url: "https://incidentdatabase.ai/cite/541/" },
    ],
    uxContext:
  ...
  },
  {
    ...
    links: [
      { text: "Deusto University - Overreliance on biased AI in health decisions", url: "https://www.deusto.es/en/home/show-news?p_p_id=com_liferay_asset_publisher_web_portlet_AssetPublisherPortlet_INSTANCE_RlbnzTjKMOoM&p_p_lifecycle=0&p_p_state=normal&_com_liferay_asset_publisher_web_portlet_AssetPublisherPortlet_INSTANCE_RlbnzTjKMOoM_assetEntryId=1071714" },
      { text: "Microsoft Research - Overreliance on AI Review", url: "https://www.microsoft.com/en-us/research/publication/overreliance-on-ai-literature-review/" },
    ],
    uxContext:

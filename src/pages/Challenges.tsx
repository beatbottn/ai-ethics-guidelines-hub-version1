...
const challenges = [
  ...
  },
  {
    ...
    titleEn: "Black Box",
    description:
      חוסר יכולת להבין כיצד ה-AI הגיע למסקנה מסוימת או לזהות דפוס מסוים (Black Box).

במחקר, זה הופך את תהליך הניתוח למשימה שמאד מקשה על ניתוח ״בעין אנושי״ את התובנות האמיתיות החבויות במידע שנאסף, וזה בעיקר עלול להקשות על זיהוי הטיות נסתרות או איתור של תופעות השטחה כמו - Average washing.,
    realWorldExample:

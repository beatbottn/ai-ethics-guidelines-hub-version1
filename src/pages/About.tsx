        ...
        <div className="card-elevated p-8 space-y-6">
          ...
          <div className="prose prose-lg max-w-none text-foreground/90 space-y-4">
            <p className="text-lg leading-relaxed">
              המדריך מבוסס על עקרונות שגובשו מסקירה רוחבית וניתוח דוחות והנחיות ממארגונים אקדמיים, גופי מחקר וחברות
              טכנולוגיה.
            </p>
            <p className="text-lg leading-relaxed">
              בהמלצות בחרנו להתמקד בהנחיות מעשיות לממשקי צ'ט בהם נעשה רוב השימוש היומיומי במשימות בתהליך המחקר - בשל
              ריבוי הכלים והממשקים בהם ניתן להשתמש ביכולות של בינה מלאכותית.
            </p>
            <p className="text-lg leading-relaxed">
              העקרונות האתיים מבוססים על מסגרות אתיות מוכרות כמו דו"ח בלמונט (Belmont Report) ועקרונות אתיים מוכרים
              בתחום המחקר המדעי והרפואי, המותאמים לתחום מחקר המשתמשים.
            </p>
          </div>
        </div>

      ...
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <Collapsible open={isMethodologyOpen} onOpenChange={setIsMethodologyOpen} className="card-elevated p-8">
          <div className="flex items-center gap-4">
            ...
            <CollapsibleTrigger type="button" className="p-1 hover:bg-muted rounded transition-colors self-center" aria-label={isMethodologyOpen ? "סגור מקורות" : "פתח מקורות"}>
          ...
          <CollapsibleContent className="space-y-6 pt-6">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  <a href="https://www.hhs.gov/ohrp/regulations-and-policy/belmont-report/index.html" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                    Belmont Report
                  </a>{" "}
                  | The National Commission | 1976
                </li>
                <li>
                  <a href="https://www.turing.ac.uk/sites/default/files/2019-08/understanding_artificial_intelligence_ethics_and_safety.pdf" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  <a href="https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32024R1689" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                    AI Act (Regulation (EU) 2024/1689)
                  </a>{" "}
                  | European Commission (EU) | 2024
                </li>
                <li>
                  <a href="https://legalinstruments.oecd.org/en/instruments/OECD-LEGAL-0449" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                    Recommendation of the Council on Artificial Intelligence (OECD AI Principles)
                  </a>{" "}
                  | OECD | 2019 (מעודכן ל-2024)
                </li>
                <li>
                  <a href="https://www.idi.org.il/media/21222/human-machine-state.pdf" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  <a href="https://research-and-innovation.ec.europa.eu/document/download/2b6cf7e5-36ac-41cb-aab5-0d32050143dc_en?filename=ec_rtd_ai-guidelines.pdf" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                    Living guidelines on the responsible use of generative AI in research
                  </a>{" "}
                  | European Commission | 2025
                </li>
                <li>
                  <a href="https://www.york.ac.uk/staff/research/governance/research-policies/generative-ai/" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                    Responsible AI Use in Research Policy
                  </a>{" "}
                  | University of York | 2024
                </li>
                <li>
                  <a href="https://www.ibm.com/design/practices/#ibm-design-for-ai" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                    IBM Design for AI: Ethics & Practices
                  </a>{" "}
                  | IBM | 2024
                </li>
                <li>
                  <a href="https://maze.co/collections/ai/ethics-user-research/" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
            ...
            <div className="space-y-3">
              ...
              <ul className="list-disc list-inside space-y-2 text-foreground/80">
                <li>
                  <a href="https://lumivero.com/resources/blog/state-of-ai-in-qualitative-research/" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                ...
                <li>
                  <a href="https://rfkhumanrights.org/our-voices/bias-in-code-algorithm-discrimination-in-financial-systems/" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
                ...
                <li>
                  <a href="https://doi.org/10.1007/s00146-025-02673-4" target="_blank" rel="noopener noreferrer" referrerPolicy="no-referrer" className="text-primary hover:underline">
          ...
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="space-y-3">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                כבר קרוב לשני עשורים עוסקת בחווית אנשים בפתרונות טכנולוגיים ושירותים.

מובילה בתחום חדשנות ממוקדת-אנשים ו-Responsible AI  ומלווה צוותים מגוונים (מגזר פרטי, ציבורי ושלישי) בפתרון בעיות מורכבות, בצורה ממוקדת אנשים, קולוברטיבית ואחראית. 
אני מלווה תהליכי יצירת פתרונות חדשניים, תוך התאמת הכלים והתהליכים לאופי הייחודי ולצרכים של כל צוות. 
מנחת סדנאות
 Design Thinking ו-Design sprints  לקיים שיח מקדם ולקבל החלטות מהר וביחד.
          ...
          {/* Author 2 - Naama */}
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <img src="/images/naama-new.png" alt="נעמה שפירא" className="w-28 h-28 md:w-32 md:h-32 rounded-full object-cover shrink-0 shadow-lg" />
            <div className="space-y-3">
